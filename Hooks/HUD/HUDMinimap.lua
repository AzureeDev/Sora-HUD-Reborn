    ...
    HUDMiniMap._INDEX = {
        framing_frame_1 = { --Framing Frame day 1 / Art Gallery
            {
                ...
                y = { -5300, 3700 },
                size = { 1024, 1024 },
                texture = "Assets/NepgearsyHUDReborn/Minimap/shadow_raid_5",
        ...
        mus = { --The Diamond
            {   --Upper floor
                ...
                y = { -5000, 5000 },
                size = { 2048, 1024 },
                texture = "Assets/NepgearsyHUDReborn/Minimap/mus_1",
            },
            {   --Lower floor
                x = { -10000, 10000 },
                y = { -5000, 5000 },
                size = { 2048, 1024 },
                texture = "Assets/NepgearsyHUDReborn/Minimap/mus_2",
            },
            {   --Basement
                x = { -10000, 10000 },
                y = { -5000, 5000 },
                size = { 2048, 1024 },
                texture = "Assets/NepgearsyHUDReborn/Minimap/mus_3",
            },
            bounding_boxes = {
                {   --Exterior
                    x = { max = -4200 },
        ...
        kenaz = {   --Golden Grin Casino
            {
                ...
                y = { -14450, 8350 },
                size = { 1024, 2048 },
                texture = "Assets/NepgearsyHUDReborn/Minimap/kenaz_loc_b_df",
            },
            bounding_boxes = {
                {   
                    map_index = 1,
